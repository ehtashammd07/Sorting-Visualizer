...
function quick_partition (start, end)
{
    ...
    div_update(divs[start],div_sizes[start],"yellow",div_sizes[start]);//Color update
        ...
        for(var j =start + 1; j <= end ; j++ )
        {
            ...
            if (div_sizes[ j ] < piv)
            {
                ...
                div_update(divs[i],div_sizes[i],"blue",div_sizes[i]);//Height update
                div_update(divs[j],div_sizes[j],"blue",div_sizes[j]);//Height update

                i += 1;
            }
    }
    div_update(divs[start],div_sizes[start],"red",div_sizes[start]);//Color update
    ...
    div_update(divs[start],div_sizes[start],"red",div_sizes[start]);//Height update
